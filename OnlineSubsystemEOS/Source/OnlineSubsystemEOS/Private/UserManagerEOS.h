...
public:
	 ...
	 */
	void StartAnonLogin(int32 LocalUserNum, const FOnlineAccountCredentials& AccountCredentials);

	/**
	 *	@brief Function that creates a new anon device.
	 */
	void CreateAnonDevice(int32 LocalUserNum, const FOnlineAccountCredentials& AccountCredentials);

	/**
	 * @brief Function to login the anonymous device.
	 */
	void LoginAnonDevice(int32 LocalUserNum, const FOnlineAccountCredentials& AccountCredentials);

	/**
	 * @brief Completes the login of the user.
	 */
	void CompleteAnonLogin(int32 LocalUserNum, EOS_EpicAccountId AccountId, EOS_ProductUserId UserId);
