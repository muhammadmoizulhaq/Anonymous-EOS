...
const FEOSSettings& UEOSSettings::ManualGetSettings()
{
	...
	if (!CachedSettings.IsSet())
	{
		...
		GConfig->GetBool(INI_SECTION, TEXT("bOverrideAuthLoginWithConnectLogin"), CachedSettings->bOverrideAuthLoginWithConnectLogin, GEngineIni);
...
FEOSSettings UEOSSettings::ToNative() const
{
	...
	Native.bOverrideAuthLoginWithConnectLogin = bOverrideAuthLoginWithConnectLogin;
